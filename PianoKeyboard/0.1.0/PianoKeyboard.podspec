...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PianoKeyboard.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/PianoKeyboard'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Gene De Lisa' => 'gene@rockhoppertech.com' }
#s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/PianoKeyboard.git', :tag => s.version.to_s }
...
#pod 'SwiftMusic', :path => '/Users/gene/Development/xcode/gene/Swift/mypods/SwiftMusic'
